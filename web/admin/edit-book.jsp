...
<t:adminWrapper title="Edit Book" bookExpanded="true">
    ...
    <jsp:body>
        <div class="row">
        <div class="col-md-6">
            <form method="post" id="form" action="edit" class="form-horizontal">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <input id="oldISBN" value="${oldISBN}" type="text" name="oldISBN" hidden required/>
                            <label class="col-sm-3 control-label">ISBN <span class="required">*</span></label>
                            <div class="col-sm-9">
                                <input id="ISBN" value="${isbn}" type="number" min="1000000000" max="9999999999" name="ISBN" class="form-control" placeholder="eg.: 978-3-16-148410-0" required/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input id="title" value="${title}" type="text" name="title" class="form-control" placeholder="eg.: The Secret" required/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select class="col-sm-9" multiple id="authors" name="authors" title="authors">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input id="publication_year" required value="${publication_year}" type="number" min="0" max="9999" name="publication_year" class="form-control" placeholder="eg.: 2018"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    ...
                                    <input name="price" value="${price}" id="price" type="number" class="form-control" placeholder="eg.: 50" required min="0" max="1000000">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input id="threshold" value="${threshold}" type="number" name="threshold" class="form-control" placeholder="eg.: 100" min="0" required/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select title="category" name="category" required class="form-control mb-md">
                                    <option <c:if test="${category == 'Science'}">selected</c:if> value="Science">Science</option>
                                    <option <c:if test="${category == 'Art'}">selected</c:if> value="Art">Art</option>
                                    <option <c:if test="${category == 'Religion'}">selected</c:if> value="Religion">Religion</option>
                                    <option <c:if test="${category == 'History'}">selected</c:if> value="History">History</option>
                                    <option <c:if test="${category == 'Geography'}">selected</c:if> value="Geography">Geography</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input id="stock_order_quamntity" value="${stock_order_quamntity}" type="number" name="stock_order_quamntity" class="form-control" placeholder="eg.: 100" min="1" required/>
                    ...
                    <footer class="panel-footer">
                        <div class="row">
                            <div class="col-sm-9 col-sm-offset-3">
                                <input type="submit" class="btn btn-primary" value="Edit" placeholder="eg: John Doe" />
